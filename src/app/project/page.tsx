...
export default function ProjectsPage() {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      ...
      try {
        ...
        // Fetch all projects from projecet collection
        ...
        const projectsData = projectsSnap.docs
          ...
          .filter(project => project.rollno === userData.rollno)
          .sort((a, b) => {
  ...
  const handleDownloadImage = (imageUrl: string, heading: string) => {
    ...
    link.href = imageUrl;
    link.download = `project-${heading.toLowerCase().replace(/\s+/g, '-')}.jpg`;
    link.target = '_blank';
      ...
      <div className="relative z-10 mx-4 mt-4 mb-8">
        {projects.length === 0 ? (
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 text-center">
            ...
            <p className="text-gray-500">Your projects will appear here once they are submitted.</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="mb-4">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    {project.imageurl && (
                      <button
                        onClick={() => handleDownloadImage(project.imageurl, project.heading)}
                ...
                <div className="flex justify-between items-center pt-3 border-t border-gray-100">
                  <span className="text-xs text-gray-500">Roll No: {project.rollno}</span>
